...
//				JOptionPane.showMessageDialog(null, "Ngày sinh phải sau 15 ngày");
...
//					JOptionPane.showMessageDialog(null, "Số điện thoại đã tồn tại !");
					lblthongbao.setText("Số điện thoại đã tồn tại !");
					txtSDT.selectAll();
					txtSDT.requestFocus();
					return false;
				}
...
//			JOptionPane.showMessageDialog(null, "CMND /CCCD 9 hoặc 12 số ");
			lblthongbao.setText("CMND /CCCD 9 hoặc 12 số ");
			txtCCCD.selectAll();
			...
			for(KhachHang KH:listKH) {
				if(KH.getCmnd().equals(cccd)) {
//					JOptionPane.showMessageDialog(null, "Căn cước đã tồn tại !");
					lblthongbao.setText("Căn cước đã tồn tại ! ");
					txtCCCD.selectAll();
					txtCCCD.requestFocus();
					return false;
				}
